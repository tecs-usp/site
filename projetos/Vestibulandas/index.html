...
<body>
  ...
  <div class="pseudo-background"></div> <!--pro fundo não ficar branco; também é padding-->
    ...
    <div class="text-center">
			...
			<h6 class="after-title">Introdução à Programação 
    ...
    <img
      ...
      alt='Um dos cadernos do curso (no Google Colaboratory), com explicações teóricas.'
    >
    <img
      class="image-thing1"
      src="https://tecs.ime.usp.br/assets/img/Vestibulandas/caderno-exercicios.png"
      title="Caderno de Exercícios"
      alt='Um dos cadernos do curso (no Google Colaboratory), com exercícios de programação.'
    >
